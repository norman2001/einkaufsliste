...
function toggleButton (e) {
  ...
  var button = form.querySelector('#input-submit')

  // Select all input fields
  var inputArtikel = form.querySelector('#article-input')
  var selectEinheit = form.querySelector('#unit-select')
  var inputMenge = form.querySelector('#piece-input')
...
function createNewRow (artikel, einheit, menge, id, rev) {
  ...
  newRow.classList.add('articleRow', 'row')
...
function handleFormSubmit (e) {
  ...
  var artikel = form.querySelector('#article-input').value
  ...
  var menge = form.querySelector('#piece-input').value
  ...
  form.querySelector('#article-input').focus()
}
